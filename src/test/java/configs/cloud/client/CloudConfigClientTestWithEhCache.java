...
public class CloudConfigClientTestWithEhCache {
	
	CloudConfigClient tester = new CloudConfigClient("dG04MHBwUEJsMG81NU1GUktYZmEy","https://app.configs.cloud/",true,CacheProvider.EHCACHE); // MyClass is tested
	...
	public CloudConfigClientTestWithEhCache(){
